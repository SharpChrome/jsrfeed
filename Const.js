...
function generateConstObject(){
    var chars = function(c,num){
        return (num > 0 ? c + chars(c,num-1) : "");
    };

    var URI_LOGIN = 'https://www.google.com/accounts/ClientLogin';
    var URI_PREFIXE_READER =  'http://www.google.com/reader/';
    var ATOM_PREFIXE_USER = 'user/-/';
    var ATOM_PREFIXE_STATE_GOOGLE = ATOM_PREFIXE_USER + 'state/com.google/';
    
    return ({
        URI_LOGIN: URI_LOGIN,
        URI_PREFIXE_READER: URI_PREFIXE_READER,
        URI_PREFIXE_ATOM: URI_PREFIXE_READER + 'atom/',
        URI_PREFIXE_AP  : URI_PREFIXE_READER + 'api/0/',
        URI_PREFIXE_VIEW: URI_PREFIXE_READER + 'view/',
        ATOM_GET_FEED :'feed/',
        ATOM_PREFIXE_USER: 'user/-/',
        ATOM_PREFIXE_USER_NUMBER: 'user/'+chars('0',20)+'/',
